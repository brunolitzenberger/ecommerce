...
$app->post("/checkout", function(){
	...
	if (!isset($_POST['desnumber']) || $_POST['zipcode'] === '') {
...
$app->post("/profile", function(){
	...
	if($_POST['desemail'] != $user->getdesemail()){
		...
		if(User::checkLoginExist($_POST['desemail']) === true){
			...
			User::setError("Este endereço de e-mail já está sendo utilizado!");
			header("Location: /profile");
			exit;
...
$dadosboleto["endereco2"] = $order->getdescity(). " - " .$order->getdesstate(). " - " .$order->getdescountry(). " CEP: ". $order->getnrzipcode(	);
